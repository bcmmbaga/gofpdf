...
![](https://github.com/bcmmbaga/gofpdf/raw/master/image/logo_gofpdf.jpg?raw=true)
...
``` shell
go get github.com/bcmmbaga/gofpdf
```

Later, to receive updates, run

``` shell
go get -u -v github.com/bcmmbaga/gofpdf/...
```
...
[fpdf\_test.go](https://github.com/bcmmbaga/gofpdf/blob/master/fpdf_test.go)
